...
export default {
    calendar: {
        ...
        input: ({ props }) => ({
            class: [
                'bg-white  ring-1 p-2 ring-gray-300 focus:outline-none hover:ring-kena-black-500 text-kena-black-600 p-3 border-round border-none flex gap-2 transition-all duration-100',
                'hover:border-blue-500', //Hover
                props.showIcon ? 'rounded-l-md' : 'rounded-md'
            ]
        }),
        panel: ({ props }) => ({
            class: [
