    ...
    dialog: {
        ...
        transition: ({ props }) => {
            return props.position === 'top'
                ? {
                    enterFromClass: 'opacity-0 translate-x-0 -translate-y-full translate-z-0',
                    enterActiveClass: 'transition-all duration-200 ease-out',
                    leaveActiveClass: 'transition-all duration-200 ease-out',
                    leaveToClass: 'opacity-0 translate-x-0 -translate-y-full translate-z-0'
                }
